...
//{
//    public struct KalmiaConfig_Old 
//    {
...
//        public KalmiaConfig_Old(string jsonString)
//        {
//            this = (KalmiaConfig_Old)JsonSerializer.Deserialize(jsonString, typeof(KalmiaConfig_Old));
//            if (this.ThreadNum == 0)
//                this.ThreadNum = Environment.ProcessorCount;
//        }
//    }

//    public class KalmiaEngine_Old : GTPEngine
//    {
//        new const string NAME = "Kalmia";
//        new const string VERSION = "Prototype";

//        const int DEFAULT_MAX_NODE_COUNT = 20000000;

//        readonly ReadOnlyDictionary<string, Func<string[], string>> COMMANDS;
//        readonly KalmiaConfig_Old CONFIG;
...
//        public KalmiaEngine_Old(KalmiaConfig_Old config, string logFilePath) : base(NAME, VERSION)
//        {
...
//            this.tree = new UCT_Old(this.valueFunc, config.UCBFactorInit, config.UCBFactorBase, (config.MaxNodeCount != 0) ? config.MaxNodeCount : DEFAULT_MAX_NODE_COUNT, config.ThreadNum);
//            this.lastMove = new Move(StoneColor.Black, BoardPosition.Null);
...
//        public override Move GenerateMove(StoneColor color)
//        {
//            if (this.CONFIG.EnablePondering && this.searchTask != null && !this.searchTask.IsCompleted)
//                StopPondering();
...
//            if (this.CONFIG.EnablePondering && this.board.GetGameResult(StoneColor.Black) == GameResult.NotOver)
//                StartPondering();
//            return move;
//        }

//        public override Move RegGenerateMove(StoneColor color)
//        {
...
//        {
//            var sb = new StringBuilder($"ellapsed={this.tree.SearchEllapsedTime}[ms] {this.tree.PlayoutCount}[playouts] {this.tree.Pps}[pps] {this.tree.SearchedNodeCount}[nodes] {this.tree.VisitedEdgeCount}[boards] {this.tree.Nps}[nps] winning_rate={rootEval.Value * 100.0f}%\n");
...
//                var moveCount = 0;
//                while(moveCount < n && board.GetGameResult(StoneColor.Black) == GameResult.NotOver)
//                {
