...
namespace engine
{
	...
	EngineOption::EngineOption(const string& value, size_t idx, const EventHandler& on_value_change) : _default_value(value), _current_value(value), _idx(0), _type("string"), _min(0), _max(0), on_value_change(on_value_change) {}
